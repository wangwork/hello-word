...
if(localStorage.getItem("sentLikn")!=="" && localStorage.getItem("sentLink")!==null){
  document.getElementById("one").style.display='none';
  document.getElementById("two").style.display='block';
  document.getElementById("three").style.display="none";
}
window.onload=function(){
//	console.log(localStorage.sentEmail);
//	console.log(JSON.stringify(localStorage.getItem("sentEmail")));
//	console.log(JSON.parse((localStorage.getItem("sentEmail"))));
//	console.log(JSON.parse((localStorage.getItem("sentEmail"))));
	var submit_01=document.getElementById("submit_01");
	var opens=document.getElementById("two");
	var links=document.getElementById("links")
	var all=document.getElementById("page-container");
	opens.onclick=function(){
          ...
          fb.attr("href", fb_href+"u="+localStorage.getItem("sentLink"));
          tw.attr("href", tw_href+"u="+localStorage.getItem("sentLink"));
		  links.innerText=localStorage.getItem("sentLink");
    ...
    if (email == "") {
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          tw.attr("href", tw_href+"u="+social_url);
          link.text(social_url);
          localStorage.setItem("sentLink",social_url);
          var mailText = "mailto:?",
              subject = 'subject=Look it',
              body = '&body=http://example.com?kid=123';

          mail.attr("href", mail.attr('href') + social_url);
